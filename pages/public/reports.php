...
<html dir="ltr" lang="en">
    <head>
        ...
        <meta name="description" content="Public article compilation in an editorial card view.">
        ...
        <style>
            ...
            .news-card .thumb { width: 140px; max-height: 100px; background: #eef0f3; flex-shrink: 0; }
            ...
            <section class="container py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <h1 class="h4 fw-bold m-0">Article Compilation</h1>
                        <p class="text-muted m-0">Combined updates and articles across projects.</p>
                    </div>
                </div>

                <div class="card border-0 shadow-sm mb-4" id="articles-section">
                    <div class="card-body">
                        <div class="project-heading mb-3">
                            <span class="fw-bold">All Articles</span>
                            <span class="text-muted small">Public view</span>
                        </div>
