<?php 
    ...
    $article_sql = "SELECT a.*, pd.ProjectDetails_Title, pd.ProjectDetails_Barangay 
                    FROM articles_table a 
                    INNER JOIN projects_table p ON a.Project_ID = p.Project_ID 
                                ...
                                <form class="row g-3" action="/QTrace-Website/database/controllers/edit_article.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select" name="project" required>
                                            ...
                                            ?>
                                                <option value="<?= $proj['Project_ID'] ?>" <?= $proj['Project_ID'] == $article['Project_ID'] ? 'selected' : '' ?>>
                                                    <?= htmlspecialchars($proj['ProjectDetails_Title']) ?>
                                                </option>
                                            <?php endwhile; ?>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        ...
                                        <select class="form-select" name="report_type">
                                            ...
                                            <option value="Report" <?= $article['article_type'] == 'Report' ? 'selected' : '' ?>>Report</option>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php if(!empty($article['article_photo_url'])): ?>
                                            <div class="mb-3">
                                                ...
                                                <img src="<?= htmlspecialchars($article['article_photo_url']) ?>" alt="Article" style="max-width: 200px; border-radius: 8px;">
                                            </div>
                                        <?php endif; ?>
